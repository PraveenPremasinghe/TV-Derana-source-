    ...
    <div>
      ...
      <div className="MaincategoryContainer2">
        ...
        <div className="row Channel">
          <div className="col-6 Channelimg">
            <img src={Mainbanner} width="100%" />
          </div>
          <div className="col-6 ChannelDetails">
            Lorem Ipsum is simply dummy text of the printing and typesetting
...
<div className="contactusmain">
    ...
    <div class="material-textfield">
      <input placeholder="Enter" type="tel" id="phone" name="phone" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}"/>
      <label>Phone number</label>
    </div>

    <div class="material-textfield">
      <textarea  placeholder="Message" type="text" rows="8" cols="50"/>
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.7240674488053!2d79.85788561455897!3d6.9235516949975295!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae25913cac2f959%3A0x718664ff29f08a9f!2sTV%20Derana!5e0!3m2!1sen!2slk!4v1657813909206!5m2!1sen!2slk" width="100%" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
</div>
            </div>
