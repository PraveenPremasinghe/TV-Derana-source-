...
const TopNav = props => {
 ...
 <section >
          ...
          <div className="row justify-content-between">
            <div className="col-md-8 order-md-last">
              ...
              <div className="row p-3">
                ...
                <Link to ="/"> <img src={deranalogo} /></Link>
                </div>
        ...
        <nav className="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
		  ...
		  <button className="navbar-toggler" type="button" data-toggle="collapse" data-target="#ftco-nav" aria-controls="ftco-nav" aria-expanded={!isNavCollapsed ? true : false} aria-label="Toggle navigation" onClick={handleNavCollapse}>
            ...
            <div className={`${isNavCollapsed ? 'collapse' : ''} navbar-collapse`} id="ftco-nav">
              <ul className="navbar-nav m-auto">
                ...
                <li className="nav-item active"><div className="nav-link"><Link to ="/">Home</Link></div></li>
                <li className="nav-item "><Link to ="/programmerShedule" className="nav-link">Programme schedule</Link></li>
                <li className="nav-item"><Link to ="/dramaEpisodes" className="nav-link">Drama Episodes</Link></li>
                ...
                <li className="nav-item"><Link to ="/#" className="nav-link"> Reality shows</Link></li>
                <li className="nav-item"><Link to ="/#" className="nav-link"> About us</Link></li>
                <li className="nav-item"><Link to ="/#" className="nav-link"> TV Derana-Srilanka</Link></li>
